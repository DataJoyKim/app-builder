...
class WorkflowErrorMessageNodeTest {
    ...
    public void 조건에_걸리면_설정한_에러응답으로_끝나고_뒤의_노드는_실행하지_않는다() {
        ...
        assertEquals(com.prometis.appbuilder.app.dto.ResultType.ERROR, response.getResultType());
    ...
    public void 조건에_걸리지_않으면_다른_가지로_정상_실행된다() {
        ...
        assertEquals(com.prometis.appbuilder.app.dto.ResultType.SUCCESS, response.getResultType());
